const businessConfig = {
  default: {
    modules: ['ventas', 'productos', 'promociones', 'inventario', 'clientes', 'proveedores', 'caja', 'colacobro', 'posmovil', 'reportes', 'rrhh', 'labels', 'movimientos', 'usuarios', 'configuracion', 'delivery', 'archivos', 'wabot'],
    productFields: [],

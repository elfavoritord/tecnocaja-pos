...
class Producto {
  const Producto({
    ...
    this.controlaVencimiento = false,
    this.laboratorio,
  ...
  double get precioSinItbis =>
      itbisIncluido ? precioVenta / (1 + tasaItbis) : precioVenta;

  double get montoItbisUnitario =>
      itbisIncluido ? precioVenta - precioSinItbis : precioVenta * tasaItbis;
  ...
  Producto copyWith({
    ...
    return Producto(
      ...
      tasaItbis: tasaItbis ?? this.tasaItbis,
      itbisIncluido: itbisIncluido ?? this.itbisIncluido,
      imagenPath: imagenPath ?? this.imagenPath,
      stockMinimo: stockMinimo ?? this.stockMinimo,
      proveedorId: proveedorId ?? this.proveedorId,
      activo: activo ?? this.activo,
      favorito: favorito ?? this.favorito,
      esCompuesto: esCompuesto ?? this.esCompuesto,
      tieneVariantes: tieneVariantes ?? this.tieneVariantes,
      tieneLotes: tieneLotes ?? this.tieneLotes,
      ubicacion: ubicacion ?? this.ubicacion,
      controlaVencimiento: controlaVencimiento ?? this.controlaVencimiento,
      ...
      esControlado: esControlado ?? this.esControlado,
      creadoEn: creadoEn,
  ...
  Map<String, Object?> toMap() => {
        ...
        'es_paquete': esPaquete ? 1 : 0,
        'contenido_paquete': contenidoPaquete,
        'precio_compra': precioCompra,
        'precio_venta': precioVenta,
        'precio_minimo': precioMinimo,
        'tasa_itbis': tasaItbis,
        'itbis_incluido': itbisIncluido ? 1 : 0,
        'imagen_path': imagenPath,
        'stock_minimo': stockMinimo,
        'proveedor_id': proveedorId,
        'activo': activo ? 1 : 0,
        'favorito': favorito ? 1 : 0,
        'es_compuesto': esCompuesto ? 1 : 0,
        'tiene_variantes': tieneVariantes ? 1 : 0,
        'tiene_lotes': tieneLotes ? 1 : 0,
        'controla_vencimiento': controlaVencimiento ? 1 : 0,
        'laboratorio': laboratorio,
        'principio_activo': principioActivo,
        'presentacion': presentacion,
        'concentracion': concentracion,
        'registro_sanitario': registroSanitario,
        'es_controlado': esControlado ? 1 : 0,
        'ubicacion': ubicacion,
  ...
  factory Producto.fromMap(Map<String, Object?> map) => Producto(
        ...
        controlaVencimiento: (map['controla_vencimiento'] as int? ?? 0) == 1,
        laboratorio: map['laboratorio'] as String?,
        principioActivo: map['principio_activo'] as String?,
        presentacion: map['presentacion'] as String?,
        concentracion: map['concentracion'] as String?,
        registroSanitario: map['registro_sanitario'] as String?,
        esControlado: (map['es_controlado'] as int? ?? 0) == 1,

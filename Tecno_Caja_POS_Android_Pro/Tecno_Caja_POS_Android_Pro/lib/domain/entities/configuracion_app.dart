...
class ConfiguracionApp {
  ...
  ConfiguracionApp copyWith({
    String? empresaId, bool? monedaSecundariaActiva, double? tasaCambioUsdDop,
    bool? redondeoActivo, double? redondeoPaso, double? itbisDefault, String? prefijoFactura,
    int? secuenciaFacturaActual, int? periodoGraciaOfflineDias, String? tema,
    ...
    return ConfiguracionApp(
      ...
      monedaSecundariaActiva: monedaSecundariaActiva ?? this.monedaSecundariaActiva,
      ...
      secuenciaFacturaActual: secuenciaFacturaActual ?? this.secuenciaFacturaActual,
      periodoGraciaOfflineDias: periodoGraciaOfflineDias ?? this.periodoGraciaOfflineDias,
      tema: tema ?? this.tema,
      impresoraPredeterminadaMac: impresoraPredeterminadaMac ?? this.impresoraPredeterminadaMac,
  ...
  factory ConfiguracionApp.fromMap(Map<String, Object?> map) => ConfiguracionApp(
        empresaId: map['empresa_id'] as String?,
        monedaSecundariaActiva: (map['moneda_secundaria_activa'] as int? ?? 0) == 1,
        ...
        periodoGraciaOfflineDias: map['periodo_gracia_offline_dias'] as int? ?? 7,
        tema: map['tema'] as String? ?? 'sistema',
        impresoraPredeterminadaMac: map['impresora_predeterminada_mac'] as String?,

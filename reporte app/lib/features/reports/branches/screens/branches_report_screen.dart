...
const _branchesQueryTimeout = Duration(seconds: 12);

// ─── Provider ─────────────────────────────────────────────────────────────────

final _branchesProvider = FutureProvider.autoDispose
    .family<List<BranchModel>, String>((ref, businessId) async {
    ...
    return ReportScaffold(
      ...
      body: branchesAsync.when(
        ...
        data: (branches) {
          ...
          final totalInvoices = branches.fold<int>(
            0,
            (s, b) => s + b.totalInvoices,
          );
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: _Stat('Facturas', '$totalInvoices')),
                ],
              ),
            ),
          ],

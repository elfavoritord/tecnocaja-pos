...
const _fiscalQueryTimeout = Duration(seconds: 12);
...
final _fiscalProvider = FutureProvider.family<_FiscalOverview, _FiscalParams>((
  ...
  // ref.read en vez de ref.watch: evita reinicio del FutureProvider en cada
  // actualización del StreamProvider del perfil (causa freeze de loading).

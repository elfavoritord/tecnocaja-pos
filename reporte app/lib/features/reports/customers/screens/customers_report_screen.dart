...
final _customersProvider =
    FutureProvider.autoDispose.family<_CustomerOverview, String>(
  (ref, businessId) async {
    ...
    final totalRevenue =
        customers.fold<double>(0, (s, c) => s + c.totalPurchases);
...
class _CustomersReportScreenState
    extends ConsumerState<CustomersReportScreen> {
  String _search = '';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: AppColors.chartColors[
                        (rank - 1) % AppColors.chartColors.length]

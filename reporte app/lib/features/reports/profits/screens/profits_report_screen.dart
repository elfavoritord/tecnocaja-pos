...
const _profitsQueryTimeout = Duration(seconds: 12);
...
final _profitsProvider = FutureProvider.autoDispose
    .family<_ProfitOverview, _ProfitParams>((ref, params) async {
      ...
      for (final sale in sales) {
        final branch = sale.branchName.isNotEmpty
            ? sale.branchName
            : 'Principal';
              ...
              children: cats.asMap().entries.map((entry) {
                ...
                return Padding(
                  padding: EdgeInsets.only(
                    bottom: isCompact(context) ? 10 : 14,
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [

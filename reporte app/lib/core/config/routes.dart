...
import '../../features/reports/inventory/screens/product_manage_screen.dart';
...
class AppRoutes {
  ...
  static const String productManage = '/reports/inventory/manage';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => ProductManageScreen(
          product: state.extra is ProductModel
